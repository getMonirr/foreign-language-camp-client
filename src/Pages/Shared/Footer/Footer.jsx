...
const Footer = () => {
  return (
    <>
      <div className="bg-camp-primary-hover">
        <CampContainer>
          <footer className="footer p-10 bg-camp-primary-hover text-white py-20">
            <div>
        ...
        <div className="bg-base-300">
          <CampContainer>
            <div className="footer footer-center p-10 bg-base-300 text-base-content rounded">
              <div>
              ...
              <div>
                <p>Copyright © 2023 - Foreign Language Camp</p>
              </div>
            </div>
          </CampContainer>
        </div>
