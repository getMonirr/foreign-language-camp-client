...
const PopularInstructorCard = ({ instructor }) => {
  ...
  return (
    ...
    //   </div>
    // </div>
    <div className="grid grid-cols-1 lg:grid-cols-2 items-center shadow-2xl hover:shadow-sm  p-6 rounded-lg gap-4 group">
      <div>
        <img
          className="rounded-full h-52 w-52 object-cover object-center border-8 shadow-xl group-hover:scale-90 transition-all"
          src={image}
          alt={name}
        />
      </div>
