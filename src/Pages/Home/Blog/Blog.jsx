      ...
      <div className="container my-24 mx-auto md:px-6">
        ...
        <section className="mb-32">
          <SectionHeading title="latest article">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel est nam
            sit velit, illum neque dolore quam vitae ipsa rerum nemo natus
            fugiat ea, optio corrupti, debitis maiores fuga odio!
          </SectionHeading>
          <div className="mb-16 flex flex-wrap">
            ...
            <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
              <h3 className="mb-4 text-2xl font-bold">Student learning</h3>
              ...
              <p className="mb-6 text-gray-600 dark:text-gray-600">
          ...
          <div className="mb-16 flex flex-wrap lg:flex-row-reverse">
            ...
            <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pr-6">
              <h3 className="mb-4 text-2xl font-bold">Teacher guideline</h3>
