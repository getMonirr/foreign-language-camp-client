      ...
      <CampContainer>
        <div className="drawer lg:drawer-open">
          ...
          <div className="drawer-content ">
            ...
            <label
              htmlFor="my-drawer"
              className="btn btn-primary bg-camp-primary border-camp-primary hover:bg-camp-secondary  hover:border-camp-primary drawer-button lg:hidden ml-auto"
            >
          ...
          <div className="drawer-side dash-menu">
            <label
              htmlFor="my-drawer "
              className="drawer-overlay hidden lg:block"
            ></label>
